    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          {/* FIXED: OAuth buttons with white background so black text is visible */}
          <div className="grid grid-cols-2 gap-3">
            <Button
              variant="outline"
              className="h-10 bg-white border-slate-200 text-slate-700 hover:bg-slate-50 gap-2 text-sm font-medium"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                {/* FIXED: Added text-slate-900 and bg-white to ensure dark text on light background */}
                <Input
                  id="email"
                  type="email"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                {/* FIXED: Added text-slate-900 and bg-white */}
                <Input
                  id="password"
