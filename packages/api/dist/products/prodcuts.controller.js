...
let ProductsController = class ProductsController {
    ...
    async findAll(page = '1', limit = '10', minPrice, maxPrice, category, status) {
        const filters = {
        ...
        return this.productsService.findAll(parseInt(page), parseInt(limit), filters);
    }
    async getStats() {
    ...
    async getLowStock(threshold = '10') {
        return this.productsService.getLowStock(parseInt(threshold));
    }
    async findOne(id) {
